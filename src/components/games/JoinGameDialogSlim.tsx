...
/**
 * Dialog component for joining a game room by code
 * Uses slim wallet check to avoid unnecessary transaction loading
 */
export function JoinGameDialogSlim({ open, onOpenChange }: JoinGameDialogProps) {
  const [roomCode, setRoomCode] = useState("");
  const { joinRoom, isLoading } = useJoinRoom();
  
  // Use the new wallet check hook instead of useWallet directly
